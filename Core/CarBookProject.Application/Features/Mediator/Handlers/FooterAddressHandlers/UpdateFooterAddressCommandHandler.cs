...
namespace CarBookProject.Application.Features.Mediator.Handlers.FooterAddressHandlers
{
	public class UpdateFooterAddressCommandHandler : IRequestHandler<UpdateFooterAddressCommand>
	{
		...
		public async Task Handle(UpdateFooterAddressCommand request, CancellationToken cancellationToken)
		{
			...
			values.FooterPhoneNumber = request.FooterPhoneNumber;
			values.FooterDescription = request.FooterDescription;
			values.FooterLocation	 = request.FooterLocation;
			values.FooterMail		 = request.FooterMail;
