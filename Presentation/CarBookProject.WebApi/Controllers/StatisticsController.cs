...
namespace CarBookProject.WebApi.Controllers
{
	...
	public class StatisticsController : ControllerBase
	{
		...
		[HttpGet("GetCarCountByMilleageSmallerThen1000")]
		public async Task<IActionResult> GetCarCountByMilleageSmallerThen1000()
		{
			var value = await _mediator.Send(new GetCarCountByMilleageSmallerThen1000Query());
			return Ok(value);
		}
		...
		[HttpGet("GetCarNameByMinPrice")]
		public async Task<IActionResult> GetCarNameByMinPrice()
		{
			var value = await _mediator.Send(new GetCarNameByMinPriceQuery());
			return Ok(value);
		}

		[HttpGet("GetCarNameByMostPrice")]
		public async Task<IActionResult> GetCarNameByMostPrice()
		{
			var value = await _mediator.Send(new GetCarNameByMostPriceQuery());
			return Ok(value);
		}
