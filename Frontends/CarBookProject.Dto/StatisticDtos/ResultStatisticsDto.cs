...
namespace CarBookProject.Dto.StatisticDtos
{
	public class ResultStatisticsDto
	{
		...
		public int auhtorCount { get; set; }
		...
		public int carCountByMilleageSmallerThen1000 { get; set; }
		public int carCountByTransmissionIsAuto { get; set; }		
		public string carNameByMinPrice { get; set; }		
		public string getCarNameByMostPrice { get; set; }		
